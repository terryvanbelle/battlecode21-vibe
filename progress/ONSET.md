...
|---|---|---|---|---|---|---|---|---|
| r50 | navMoves | -0.46 | -0.39 | -0.40 | -0.42 | -0.44 | -0.36 | -0.20 |
| r50 | navMoves ~avg | -0.45 | -0.39 | -0.40 | -0.42 | -0.45 | -0.42 | -0.31 |
...
| r100 | navAba [inverted] | +0.44 | +0.26 | +0.30 | +0.39 | +0.43 | +0.30 | +0.12 |
| r100 | navAba [inverted] ~avg | +0.44 | +0.26 | +0.31 | +0.38 | +0.44 | +0.37 | +0.25 |
...
| - | cov | +0.18 | +0.05 | +0.05 | +0.16 | +0.18 | +0.04 | +0.06 |
| - | cov ~avg | +0.16 | +0.05 | +0.05 | +0.12 | +0.15 | +0.05 | +0.05 |
