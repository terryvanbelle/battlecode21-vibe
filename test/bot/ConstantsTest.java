...
public class ConstantsTest {
    ...
    public static void main(String[] a) {
        ...
        check(C.MUCK_IDLE_VALUE >= 0 && C.MUCK_IDLE_VALUE < C.SPEECH_MIN_VALUE && C.THREAT_SLA_D2 >= 12, "an idle muckraker alone is below the speech bar; a threat covers the expose range");
