# Handoff -- the state of the loop (updated 2026-09-23 09:05 UTC)
...
- Iteration 63 (scout caps doubled) **rejected at the block**: 35/48, strong bots 2/12; SPRT
  15-17 stopped. `iter63` keeps the code. `src/bot` = g_iter13 + archetype scaffolding. **The
  VM is idle; candidate work is closed.**
