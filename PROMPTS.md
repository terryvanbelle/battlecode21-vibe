...
> (scheduled 13:00 UTC) Shutdown time. Make sure all docs and code are up to date. Stop all jobs on the VM and free the disk space used by this project. Write a clear, accessible post-mortem in the style of Battlecode post-mortems, geared to an audience of Battlecode contestants. Commit and push
