...
public class ConstantsTest {
    ...
    public static void main(String[] a) {
        ...
        // Iteration 46: the siege rule must require real duration, not fire on a passing scare.
        check(C.SIEGE_MIN_ROUNDS >= 25 && C.SIEGE_MIN_ROUNDS < 400, "the siege rule needs sustained pressure");
        check(C.SIEGE_GUARD_CAP > C.SPEND_GUARD_CAP, "the siege ceiling is above the ordinary one");
