...
as scrimmages (random map, random side, six games per opponent per block): **334/432 (77.3%)**
over its nine blocks; **33% against awesomelemonade** (the top bot), **46% against rzhan11**,
67-100% against the other six. Elo ladder built from our own 1,248 scrimmages: rank 3 of 21
rated bots (1742), from a start of 29% overall and 7% against the top bot.
...
| **g_iter13** | cheap guards under a swarm | 119-121 (neutral) | **78/96 then 334/432**, awesomelemonade 33%, rzhan11 46% |
