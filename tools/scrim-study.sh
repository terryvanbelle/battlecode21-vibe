...
OUT="$RUN/study.tsv"
printf 'opp\tmap\twon\tround\tus_ec\tus_ecInf\tus_sla\tus_muc\tus_pol\tus_exp\tus_buff\tus_unitInf\tus_cov\tus_navMoves\tus_navAba\tus_navSwamp\tth_ec\tth_ecInf\tth_sla\tth_muc\tth_pol\tth_exp\tth_buff\tth_unitInf\tth_cov\tth_navMoves\tth_navAba\tth_navSwamp\n' > "$OUT"
NAV="$RUN/nav.tsv"
